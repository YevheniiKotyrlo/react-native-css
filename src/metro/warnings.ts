...
export function formatCompilerWarnings(
  ...
  // The fourth channel, and the one whose fix is in the reader's stylesheet
  // rather than in this package: a syntax warning is CSS lightningcss could not
  // parse, not CSS React Native cannot express.
